...
from video_processor import normalize_all, merge_videos, mix_music, add_intro_outro_and_fade
...
def run_pipeline(template_filename="study_vlog.json", clip_order=None, clip_data=None,
                 clip_audio=None, global_audio=True, clip_volume=1.0):
